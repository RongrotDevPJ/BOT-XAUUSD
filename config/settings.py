...
class Config:
    ...
    # =========================================
    TRAILING_STOP_TRIGGER = 200 # 🔧 M5: ล็อกเร็วขึ้นที่ 200 จุด
    TRAILING_STOP_LOCK = 100    # ล็อคกำไรที่ 100 จุด
    TRAILING_STOP_STEP = 50     # 🚀 ขยับทีละ 50 จุด (ลด Log รก + ลดภาระ Server)
