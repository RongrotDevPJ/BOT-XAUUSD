...
class Config:
    ...
    BREAK_EVEN_LOCK = 50       # ล็อคกำไรที่ 100 จุด (Entry + 100)

    # Stage 2: Profit Lock (65% of TP)
    ENABLE_PROFIT_LOCK = True   # เปิดใช้ระบบล็อคกำไร 50%
    PROFIT_LOCK_PERCENT = 0.80  # 🎯 ล็อคกำไรเมื่อกำไรถึง 65% ของระยะ TP
    ...
    SMC_LOOKBACK = 300            # จำนวนแท่งย้อนหลังที่เช็คหา OB
